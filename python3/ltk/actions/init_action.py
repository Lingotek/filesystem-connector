...
class InitAction():
    ...
    def init_action(self, host, access_token, client_id, project_path, folder_name, workflow_id, default_locale, browser, delete, reset):
        ...
        try:
            ...
            to_init = self.reinit(host, project_path, 'true', 'true')
            ...
            if not access_token:
                ...
                if not access_token or reset:
                    ...
                    if browser:
                        ...
                        logger.info('To begin the setup of the cloud configuration, you need to setup your token and connect your Ray Enterprise account.' + '\n' +
