...
class TestConfig(unittest.TestCase):
    ...
    def test_config(self):
        ...
        try:
            out = BytesIO()
            sys.stdout = out
            self.action.config_action(None, None, None)
            info = out.getvalue()
